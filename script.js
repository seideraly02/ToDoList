...
const translations = {
  ru: {
    ...
    'hero.badge': 'Товары со всего мира', 'hero.titleBefore': 'Находки, которые', 'hero.titleAccent': 'работают на вас',
    'hero.text': 'Помогаю покупать проверенные товары из Китая, Турции и Армении — для себя, бизнеса и вдохновения.',
    'hero.primary': 'Получить ссылки на группы', 'hero.secondary': 'Смотреть Instagram', 'hero.statFollowers': 'подписчиков',
    ...
    'directions.intro': 'Выберите нужное направление и получите доступ к актуальным товарам, новинкам и условиям заказа.', 'directions.action': 'Получить ссылку',
  ...
  kk: {
    ...
    'hero.badge': 'Әлемнің түкпір-түкпірінен тауарлар', 'hero.titleBefore': 'Сіз үшін жұмыс істейтін', 'hero.titleAccent': 'ерекше таңдаулар',
    'hero.text': 'Қытай, Түркия және Армениядан тексерілген тауарларды өзіңізге де, бизнесіңізге де сатып алуға көмектесемін.',
    'hero.primary': 'Топтарға сілтеме алу', 'hero.secondary': 'Instagram қарау', 'hero.statFollowers': 'оқырман',
    ...
    'directions.intro': 'Қажетті бағытты таңдап, өзекті тауарлар, жаңалықтар мен тапсырыс шарттарына қол жеткізіңіз.', 'directions.action': 'Сілтеме алу',
